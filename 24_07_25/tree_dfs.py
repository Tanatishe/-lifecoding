...
def dfs_recursive_preorder(root: Optional[TreeNode], result: List[int] = None) -> List[int]:
    """
...
def dfs_recursive_inorder(root: Optional[TreeNode], result: List[int] = None) -> List[int]:
    """
...
def dfs_recursive_postorder(root: Optional[TreeNode], result: List[int] = None) -> List[int]:
    """
